...
let s:comment = "#a69692b3"            " Comment color
...
exe "hi Visual guibg=".s:accent."40"
exe "hi Search guibg=".s:accent."61 guifg=".s:fg_main
exe "hi IncSearch guibg=".s:accent."61 guifg=".s:fg_main
...
exe "hi MatchParen guibg=".s:accent."4d"
exe "hi ColorColumn guibg=".s:bg_alt
exe "hi CursorLine guibg=".s:accent."0f"
...
exe "hi Delimiter guifg=".s:fg_main."66"
...
" Diff
exe "hi DiffAdd guifg=".s:green." guibg=".s:green."1a"
exe "hi DiffChange guifg=".s:blue." guibg=".s:blue."1a"
exe "hi DiffDelete guifg=".s:red." guibg=".s:red."1a"
exe "hi DiffText guifg=".s:blue." guibg=".s:blue."3d"
